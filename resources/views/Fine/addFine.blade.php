                                ...
                                <form method="post" class="new-added-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-12 form-group ">
                                            ...
                                            <input name="fine" type="text" placeholder="Enter Fine Name" class="form-control" required>
                                        </div>
                                        <div class="col-xl-12 col-lg-12 col-12 form-group ">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-12 form-group">
                                            ...
                                            <input name="fine_date" type="date" class="form-control" required>
                                        </div>
