                            ...
                            <div class="card-body">
                                ...
                                <form method="post" class="new-added-form"  action="{{ route('addTeachers') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Salary*</label>
                                            <input name="salary" type="number" placeholder="Enter Salary" class="form-control" required>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <label>Subject*</label>
                    ...
                    <div class="card-body">
                        ...
                        <form class="mg-b-20">
                            <div class="row gutters-8">
                                ...
                                <div class="col-4-xxxl col-xl-3 col-lg-3 col-12 form-group">
                                    <input id="subject" type="text" placeholder="Search by Subject ..." class="form-control">
                                </div>
...
{{--                                </div>--}}
    ...
    <script>
        ...
        document.getElementById("subject").addEventListener("keyup", function () {
            ...
            rows.forEach(row => {
                let name  = row.cells[7].textContent.toLowerCase(); // Name column
