                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" class="new-added-form" action="{{ route('feeType') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-12 form-group">
                                            <label>Fee Type*</label>
                                            <input name="fee_type" type="text" placeholder="Enter Class Fee..." class="form-control" required>
                                        </div>
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            <div class="form-check d-flex align-items-center">
                                                <input class="form-check-input me-2" type="checkbox" name="stu_enrol">
