                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-12 form-group">
                                            ...
                                            <select name="department" class="select2">
                                                ...
                                                <option value="14">Subject 1</option>
                                                <option value="15">Subject 2</option>
                                            </select>
                                        </div>
                                        <div class="col-xl-12 col-lg-12 col-12 form-group">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-12 form-group">
                                            ...
                                            <input name="t_marks" type="text" placeholder="Enter Total Marks" class="form-control" required>
                                        </div>
                                        <div class="col-xl-12 col-lg-12 col-12 form-group">
                                            <label>Year</label>
