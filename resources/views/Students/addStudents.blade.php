            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('addStudents') }}" method="post" class="new-added-form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-2 col-lg-6 col-12 form-group">
                                    ...
                                    <input name="cnic" type="text" placeholder="Enter CNIC" class="form-control"
                                           required>
                                </div>
                                <div class="col-xl-2 col-lg-6 col-12 form-group">
                                    <label>D-O-B*</label>
                                ...
                                <div class="col-xl-2 col-lg-6 col-12 form-group">
                                    ...
                                    <input name="j_date" value="{{ date('Y-m-d') }}" type="date"
                                           placeholder="Joining Date" class="form-control" readonly required>
                                </div>

                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Referance</label>
                                    <input name="referance" type="text" placeholder="Enter Referance"
                                           class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>E-mail</label>
                                ...
                                <div class="col-xl-12 col-lg-12 col-12 form-group">
                                    ...
                                    <textarea cols="12" rows="4" name="address" placeholder="Address"
                            ...
                            <div class="row">
                                ...
                                <div id="bachelor" class="col-xl-3 col-lg-6 col-12 form-group" style="display: none">
                                ...
                                <div id="semester" class="col-xl-3 col-lg-6 col-12 form-group" style="display: none">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input id="class_fee" name="class_fee" type="text" placeholder="Class Fee"
                                           class="form-control" readonly>
                                </div>
                                @foreach($feeType as $feeType)
                                    @if($feeType->stu_enrol == 1)
                                        <div class="col-xl-3 col-lg-6 col-12 form-group">
                                            ...
                                            <input name="feeType[]" type="number"
                                                   placeholder="Enter {{$feeType->fee_type}} Fee"
                                                   class="feeType form-control" required>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input id="discount" name="cls_fee_dsc" value="0" type="number"
                                           placeholder="Discount" class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Total Fee</label>
                                    <input id="total_fee" name="t_fee" value="0" type="number" placeholder="Total Fee"
                                           class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="button"
                                            class="btn btn-sm btn-fill-lg btn-gradient-yellow btn-hover-bluedark "
                                            style="font-size: 16px;">Subject List
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input name="prev_class" type="text" placeholder="Previous Class Name"
                                           class="form-control" required>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input name="o_mark" type="number" placeholder="Obtained Marks"
                                           class="form-control">
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>School /collage board</label>
                                    <input name="board" type="text" placeholder="School /collage board"
                                           class="form-control">
                                </div>
